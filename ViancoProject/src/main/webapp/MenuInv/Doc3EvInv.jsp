		...
		<form action="../CntServlet" class="Documento">
			<div class="Texto">
				<label class="eval">NOMBRE DEL EVALUADOR <input required="" class="Evaluador" type="text" size="50"
						placeholder="Ingresa el nombre del evaluador" name="nomEV" required="" ></label>
				<br><br>
				...
				<br>
				<label class="eval">NOMBRE DEL ALUMNO <input required="" class="nombreL" type="text" size="50"
						placeholder="Ingresa el nombre del Alumno" name="nombreAl"></label>
				<br>
				<label class="titu">TITULO DEL PROYECTO <input required="" class="Proyec" type="text" size="50" name="NombreP"
						id="NombreP" placeholder="ingresa el nombre del proyecto"></label> <br> <br>
				<p class="parrafo1">
			...
			<textarea class="area" placeholder="Area de Observaciones" name="observaciones" id="observaciones"
